                                ...
                                <div class="nk-kycfm">
                                    <div class="nk-kycfm-head">
                                        ...
                                        <div class="nk-kycfm-title">
                                            ...
                                            <p class="sub-title">Your simple personal information required for
                                                identification</p>
                                        </div>
                                    </div>
                                    <div class="nk-kycfm-content">
                                        <div class="nk-kycfm-note">
                                            <em class="icon ni ni-info-fill" data-toggle="tooltip"
                                                data-placement="right" title="Tooltip on right"></em>
                                            <p>Please type carefully and fill out the form with your personal details.
                                    ...
                                    <div class="nk-kycfm-head">
                                        ...
                                        <div class="nk-kycfm-title">
                                            ...
                                            <p class="sub-title">To verify your identity, please upload any of your
                                                document.</p>
                                        </div>
                                    </div>
                                    <div class="nk-kycfm-content">
                                        ...
                                        <ul class="nk-kycfm-control-list g-3">
                                            <li class="nk-kycfm-control-item">
                                                <input class="nk-kycfm-control"
                                                       ...
                                                       @click="documentType($event)">
                                                <label class="nk-kycfm-label" for="passport">
                                                    <div class="nk-kycfm-label-icon">
                                                        ...
                                                        <div class="label-icon">
                                                            <svg xmlns="http://www.w3.org/2000/svg"
                                                                ...
                                                                <path
                                                                    ...
                                                                    transform="translate(-2 -8.9898)" fill="#6476ff"/>
                                                            </svg>
                                                        </div>
                                                    </div>
                                            ...
                                            <li class="nk-kycfm-control-item">
                                                ...
                                                <small class="text-danger"
                                                       v-if="errors.type">{{ errors.type[0] }}</small>
                                            </li><!-- .nk-kycfm-control-item -->
                                        </ul>
                                        <div class="nk-kycfm-upload">
                                            ...
                                            <div class="row align-items-center">
                                                <div class="col-12">
                                                    <div class="nk-kycfm-upload-box">
                                                        <div class="upload-zone">
                                                            <div class="dz-message" data-dz-message>
                                                                ...
                                                                <vue-dropzone ref="myVueDropzone" :useCustomSlot="true"
                                                                              id="dropzone"
                                                                              :options="dropzoneOptions">
                                                                    <span
                                                                        class="dz-message-text">Drag and drop file</span>
                                                    ...
                                                    <small class="text-danger"
                                                           v-if="errors.upload_file">{{ errors.upload_file[0] }}</small>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="nk-kycfm-footer">
                                        <div class="form-group">
                                            <div class="custom-control custom-control-xs custom-checkbox">
                                                <input type="checkbox"
                                                       ...
                                                       v-model="isCorrect">
                                                <small class="text-danger"
                                                       v-if="errors.is_correct">{{ errors.is_correct[0] }}</small>
                                        ...
                                        <div class="nk-kycfm-action pt-2">
                                            <button type="button" class="btn btn-lg btn-primary"
                                                    @click.prevent="submit">Process for Verify
                                            </button>
                                        </div>
                                    </div>
                                </div>
...
export default {
    ...
    methods: {
        submit() {
            ...
            profileData.phone_number = this.phoneNumber
            profileData.is_correct = this.isCorrect ? 1 : 0;
            profileData.type = this.documentData;
            const formData = formDataAssigner(new FormData, profileData);
            if (this.$refs.myVueDropzone.getQueuedFiles().length)
                this.$refs.myVueDropzone.getQueuedFiles().forEach(el => {
                    formData.append('upload_file[]', el);
                })
        ...
        getProfile() {
            axios.get('auth/profile').then(({data}) => {
                ...
                this.phoneNumber = this.profileInfo.profile ? this.profileInfo.profile.phone_number : '';
                if (this.profileInfo.profile) {
                    this.isCorrect = this.profileInfo.profile.is_correct ? true : false;
                }
                this.documentData = this.profileInfo.document ? this.profileInfo.document.type : 'passport'
            })
        },
        documentType(event) {
            this.documentData = event.target.value;
        }
    },
